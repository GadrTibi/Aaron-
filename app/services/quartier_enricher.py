...
def _build_prompt(address: str) -> str:
    return (
        ...
        "  transport_metro_texte (max 250 caractères) : EXACTEMENT 1 item par ligne, MAX 3 lignes, format exact \"Ligne X — Station Y (5 min)\".\n"
        "    Pas de texte ni commentaire après la liste.\n"
        "  transport_bus_texte (max 250 caractères) : EXACTEMENT 1 item par ligne, MAX 3 lignes, format \"Bus 30 — Arrêt Y (2 min)\".\n"
